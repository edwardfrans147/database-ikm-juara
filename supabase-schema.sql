...
-- Create Peserta Pelatihan table (junction table)
...
CREATE INDEX idx_hki_merek_ikm_id ON hki_merek(ikm_binaan_id);
CREATE INDEX idx_sertifikat_halal_ikm_id ON sertifikat_halal(ikm_binaan_id);
CREATE INDEX idx_tkdn_ik_ikm_id ON tkdn_ik(ikm_binaan_id);
CREATE INDEX idx_siinas_ikm_id ON siinas(ikm_binaan_id);
CREATE INDEX idx_uji_nilai_gizi_ikm_id ON uji_nilai_gizi(ikm_binaan_id);
CREATE INDEX idx_kurasi_produk_ikm_id ON kurasi_produk(ikm_binaan_id);
CREATE INDEX idx_peserta_pelatihan_ikm_id ON peserta_pelatihan(ikm_binaan_id);
CREATE INDEX idx_peserta_pelatihan_pelatihan_id ON peserta_pelatihan(pelatihan_id);
...
-- Create policies for public access (read-only for public website)
...
-- Allow public to insert into buku_tamu
...
('BidIndustri08#', '$2b$10$encrypted_password_hash', 'Administrator IKM JUARA', 'super_admin');
